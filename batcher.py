...
class Batcher(object):
    ...
    def __init__(self, input_file, vocab, hps, single_pass):
        """Initialize the batcher. Start threads that process the data into batches.

        Args:
          input_file: tf.Example filepattern.
          vocab: Vocabulary object
          hps: hyperparameters
    ...
    def fill_example_queue(self):
        ...
        input_gen = self.text_generator(data.example_generator(self._input_file, self._single_pass))
